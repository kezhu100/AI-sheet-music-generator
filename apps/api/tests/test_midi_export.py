...
class MidiExportTests(unittest.TestCase):
    def test_build_midi_file_returns_valid_header_and_track_count(self) -> None:
    ...
    def test_export_endpoint_returns_midi_download(self) -> None:
        ...
        response = client.get(f"/api/v1/jobs/{job.id}/exports/midi")
    ...
    def _build_result(self):
        with TemporaryDirectory() as temp_dir:
            ...
            return build_development_pipeline().run(audio_path, "demo.wav", "job-midi")
